    ...
    getPerformanceStats() {
        ...
        return {
            ...
            updateStats: {
                ...
                average: updateTimes.length > 0 ? updateTimes.reduce((a, b) => a + b, 0) / updateTimes.length : 0,
...
export class MemoryOptimizer {
    ...
    static checkMemoryUsage(component) {
        ...
        if (component.elementPool) {
            usage.elementPoolSize = Object.values(component.elementPool)
    ...
    static detectMemoryLeaks(component) {
        ...
        // 检查元素池是否过大
        if (component.elementPool) {
            const totalPoolSize = Object.values(component.elementPool)
                .reduce((total, pool) => total + pool.length, 0);
